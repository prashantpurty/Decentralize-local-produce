    ...
    <DefaultLayout>
      ...
      <header className="bg-white dark:bg-gray-800 shadow">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Producers</h1>
        </div>
      </header>
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Featured Producers</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Become a Producer</h2>
            <Card>
              <CardBody className="pt-6">
                <p className="mb-4">Join our marketplace and reach more customers with your fresh, local produce.</p>
